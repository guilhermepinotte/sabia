...
urlpatterns = patterns('',
    ...
    url(r'^fichamentos/(?P<get_id>\d+)/ver$', views.verFichamentoFancybox, name='verfichamentofancybox'),
    ...
    url(r'^artigos/(?P<get_id>\d+)/$', views.VerArtigo, name='verartigo'),
    url(r'^artigos/(?P<get_id>\d+)/ver$', views.VerArtigoFancybox, name='verartigofancybox'),
    ...
    url(r'^artigos/exc$', views.ExcluirArtigoDatatable, name='excluirartigodatatable'),
